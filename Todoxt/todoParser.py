...
def new_todo(string):
    ...
    if todo_pre_data:
        ...
        if todo.completed:
            ...
            todo.creation_date = str(datetime.datetime.now().date())
...
def search(todos, text=None, completed=None, completion_date=None, priority=None, creation_date=None, projects=None,
